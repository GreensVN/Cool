...
local validSearchFunctions = { 
	ScriptBlox = "rbxassetid://103292399769635",
	RScripts = "rbxassetid://99609700848035"
};
...
local function loadKeyUI(callback)
	local keyFrame = create("Frame", { 
		...
		create("ImageLabel", { 
			...
			BackgroundColor3 = Color3.fromHex("ffffff"), 
			BackgroundTransparency = 1, 
			Image = "rbxassetid://127633233305707", 
		...
		create("Frame", { 
			...
			create("ScrollingFrame", { 
				...
				BackgroundTransparency = 1, 
				BorderSizePixel = 0, 
				BottomImage = "rbxassetid://119440771620530", 
				CanvasSize = UDim2.new(),
				MidImage = "rbxassetid://135260967917233", 
				Name = "container", 
				Position = UDim2.new(0.5, 0, 0.5, 0), 
				ScrollBarImageColor3 = Color3.fromHex("141414"), 
				ScrollBarThickness = 4, 
				Size = UDim2.new(1, -16, 1, -16), 
				TopImage = "rbxassetid://83507765777644"
			}, {
				create("UIListLayout", { 
					Name = "list", 
	...
	do
		...
		for i, v in next, sortedLanguageDatabase do
			...
			clone.flagContainer.icon.Image = string.format("rbxassetid://%s", v.value.flag);
			...
			create("Frame", { 
				...
				create("Frame", { 
					...
					create("ScrollingFrame", { 
						...
						BackgroundTransparency = 1, 
						BorderSizePixel = 0, 
						BottomImage = "rbxasset://119440771620530", 
